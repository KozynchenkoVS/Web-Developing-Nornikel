...
namespace DB_1
{
    internal class BuildingsContext : DbContext
    {
        public DbSet<Material> Materials { get; set; }
        public DbSet<Building> Buildings { get; set; }
        protected override void OnConfiguring (DbContextOptionsBuilder options)
        {
            options.UseSqlServer(@"Server=DESKTOP-TSHMHUG;Database=FirstTask;Trusted_Connection=True;");
    ...
    public class Building
    {
        ...
        public Material MatrialID { get; set; }
    }
